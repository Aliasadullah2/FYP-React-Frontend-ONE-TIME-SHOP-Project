...
import { loadproduct,updateProduct as doUpdateProduct, uploadImagePost } from '../Services/Product'
import { getCurrentUserDetail } from '../Auth/AuthIndex'
import { BASE_URL } from '../Services/Helper'

function AdminUpPage() {
  ...
  const updateProduct=(event)=>{
    ...
    doUpdateProduct({...product,category:{id:product.id}},product.prodId).then(response=>{
      ...
      navigate('/user/admin/SellerFreelances ');
    ...
    const updateHtml=()=>{
      return(
        <Container  >
                <Button tag={Link} color='success' to='/user/admin/SellerFreelances' className='m-3'> Back to Product </Button><br></br>
