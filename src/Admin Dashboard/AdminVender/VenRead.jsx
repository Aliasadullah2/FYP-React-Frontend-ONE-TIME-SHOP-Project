...
const VenRead = () => {
  ...
  return (
    ...
    <Container className='bg-primary' >
      <Link  className='btn btn-secondary mb-2 mt-2' to="/user/admin/buyervender">Back</Link> {vander && (<Link to='' className='text-light'>/{vander.name}</Link>)}
      <Row >
        <Col md={{size:12}}>
        <Card >
          {
