...
function CategorySide() {
  ...
  return (
    ...
    <UncontrolledDropdown inNavbar>
              ...
              <DropdownItem>
                <li>
                      <Link tag={Link} action={true} to="/mentor/buyer/BuyerDropshipping">All Products</Link>
                </li>
                  </DropdownItem>
            ...
            categories  && categories.map((cat,index)=>{
                return(
                    <DropdownItem action={true}  key={index} tag={Link} to={`/mentor/categories/`+cat.id} className='border-0 mt-1' >
                   <li>
                   {
                        cat.categorytitle
