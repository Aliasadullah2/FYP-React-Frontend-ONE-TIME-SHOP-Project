...
function Product({product={  prodName:"Product Name",prodDesc:"Product Despcription",prodPrice:"Product Price" }} ) {
  ...
  return (
   ...
   <CardBody  >
    ...
    <Link className="btn btn-primary" to={`/mentor/ProductPage/`+product.prodId} >ReadMore</Link>
