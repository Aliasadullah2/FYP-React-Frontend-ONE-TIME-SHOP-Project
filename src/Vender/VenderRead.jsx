...
const VenderRead = () => {
  ...
  return (
    ...
    <Container className='bg-primary' >
      <Link  className='btn btn-secondary mb-2 mt-2' to="/mentor/seller/myvender">Back</Link> {vander && (<Link to='' className='text-light'>/{vander.name}</Link>)}
      <Row >
        <Col md={{size:12}}>
        <Card >
          {
