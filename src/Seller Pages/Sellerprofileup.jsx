...
function Sellerprofileup() {
      ...
      useEffect(()=>{
        ...
        if(myUser){
            if(  myUser.id !== myUser.id){
                ...
                navigate(`/mentor/seller/sellerprofile-info/${id}`);
    ...
    const updateUserprofile=()=>{
        return(
            <Container  >
                <Button tag={Link} color='success' to={`/mentor/seller/sellerprofile-info/${id}`} className='m-3'> Back to Profile </Button><br></br>
                
                <form  className=" rounded bg-white shadow p-5" onSubmit={updateProfile}>
                <h3 className="text-dark fw-bolder fs-4 mb-4">Update Seller Profile </h3>
...
export default Sellerprofileup